...
def main(args):
    ...
    model = LightningClassifier(MNISTModel())
    ...
    log_path = os.path.join(log_dir, f"{args.experiment_name}/version_{trainer.logger.version}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train and evaluate a model with PyTorch Lightning")
